...
The public repository contains a demo signal engine for architecture demonstration. The production TRVM × Strict Scoring engine (10-filter dual-confirmation system) is available for review under NDA during interviews.
...
<p align="center">
  ...
  <br>
  <sub><b>trade_log.csv</b> — a 10-trade paper session: 80% win rate, profit factor 3.48, full reason-coded exit log</sub>
</p>
